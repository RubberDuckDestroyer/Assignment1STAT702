...
## Answer
First, we filter the reviews to show product B00006IE7J and then check the head of the filtered data to check this has been successful. The mean overall ranking for this product is `r  summary(my_reviews$overall)[4]`. The plot below show the number of reviews in each overall ranking. 
