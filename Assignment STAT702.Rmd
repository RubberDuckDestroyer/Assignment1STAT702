...
`r store_total_sales$store_total[1]` units. Stores ranked 1-9 are
performing highly. Stores 10 - 19 are performing adequately. Stores 20 -
29 are performing poorly.


|Rank|Store ID| Total sales|     |Rank|Store ID| Total sales|     |Rank|Store ID| Total sales|
|:---|:-------|:-----------|:----|:---|:-------|:-----------|:---|:---|:-------|:-----------| 
|`r store_total_sales$ranking[1]` |`r store_total_sales$store_id[1]` |`r store_total_sales$store_total[1]`||`r store_total_sales$ranking[10]` |`r store_total_sales$store_id[10]` |`r store_total_sales$store_total[10]`||`r store_total_sales$ranking[19]` |`r store_total_sales$store_id[19]` |`r store_total_sales$store_total[19]`
...
|`r store_total_sales$ranking[3]` |`r store_total_sales$store_id[2]` |`r store_total_sales$store_total[3]`|```{r 1b store totals}
...
Monthly performance has been classified for each store. An interquartile
range for monthly sales has been calculated with the first quartile at
`r summary(store_monthly$monthly_units)[2]` and the third quartile at
`r summary(store_monthly$monthly_units)[5]`. Monthly sales greater than
the third quartile are classified as 'High' performing. Sales
