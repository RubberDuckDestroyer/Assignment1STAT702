...
`r  summary(my_reviews$overall)[4]`. Most reviews were rated highly with 
`r (round(summary$prop[5], 1))` given 5 and `r (round(summary$prop[4], 1))` given 4 stars.

|Min|1st Qu.|Median|Mean|3rd Qu.|Max|
|:--|:------|:-----|:---|:------|:--|
|`r  summary(my_reviews$overall)[1]`|`r  summary(my_reviews$overall)[2]`|
`r  summary(my_reviews$overall)[3]`|`r  summary(my_reviews$overall)[4]`|
`r  summary(my_reviews$overall)[5]`|`r  summary(my_reviews$overall)[6]`|
...
# Count frequency of words overall
tidy_sentiment_gc %>%
...
# Count and plot frequency of words, excluding pen, pens, stars
tidy_sentiment_gc %>%
  count(reviewWord, sort = TRUE) %>% 
  filter(n > 100) %>% 
  mutate(reviewWord = reorder(reviewWord, n)) %>% 
...
tidy_sentiment_gc %>% 
  ...
  mutate(sentiment = positive - negative, linenumber = row_number()) -> sentiment_summary 
